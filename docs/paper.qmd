...
# load articles -------------------------------------------------------------
full_text_jasr_statcheck <- readRDS("data/full_text_jasr.rds")
...
plot(jasr_statcheck_results_tbl, APAstyle = TRUE) +
  ...
  annotate("text",
           ...
           label = paste0(nrow(jasr_statcheck_results_tbl), " papers in JASR\n",
             n_minor_inconsistencies, " with minor inconsistencies\n",
            n_major_inconsistencies, " with major inconsistencies"
                          )) +
  coord_fixed()
